                ...
                <div class="p-6">
                    <form action="{{ route('admin.bookings.index') }}" method="GET" class="flex flex-wrap gap-4">
                        <div class="flex-1 min-w-[200px]">
                            ...
                            <select name="status" id="status" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600">
                        ...
                        <div class="flex items-end">
                            <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-6 rounded-md transition">
                                Filter
                            </button>
                        </div>
                    </form>
                                    ...
                                    @foreach($bookings as $booking)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">
                                                {{ $booking->message ? Str::limit($booking->message, 50) : 'N/A' }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
