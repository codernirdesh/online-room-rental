<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('owner.bookings.index') }}" class="text-sm text-primary-600 hover:text-primary-800 dark:text-primary-400">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900 dark:text-white font-medium">{{ $booking->room->title }}</p>
                            ...
                            @if($booking->esewa_ref_id)
                                <div>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">eSewa Reference</p>
